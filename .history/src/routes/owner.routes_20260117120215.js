...
// GET restaurant by id (for auto-link slug)
router.get("/restaurants/:id", requireRestaurantOwnership, ownerRestaurantController.getRestaurant);
...
router.post(
  "/items/:itemId/image",
  requireResourceOwnership(MenuItem, "itemId"),
  upload.single("file"),
  ownerMenuController.uploadItemImage
);
// owner.routes.js
