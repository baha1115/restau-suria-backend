...
// ✅ NEW: GET /api/owner/restaurants/:id  (req.restaurant موجود من middleware)
const getRestaurant = asyncHandler(async (req, res) => {
  return ok(res, { restaurant: req.restaurant }, "Restaurant");
});
...
// POST /api/owner/restaurants/:id/covers
...
module.exports = { getRestaurant, createRestaurant, updateRestaurant, uploadLogo, uploadCovers };
